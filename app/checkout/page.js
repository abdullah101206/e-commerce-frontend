...
export default function CheckoutPage() {
  ...
  const cartItems = [
    { id: 1, title: "Structured Tailored Blazer", price: 280, quantity: 1, size: "M" },
    { id: 2, title: "Minimalist Linen Overshirt", price: 140, quantity: 1, size: "L" },
  ];
      ...
      {!orderPlaced ? (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-7 bg-white p-6 sm:p-10 border border-neutral-200 shadow-sm space-y-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    />
                    <div>
                      <p className="text-xs font-bold uppercase tracking-wider">Credit / Debit Card</p>
                      <p className={`text-[10px] ${formData.paymentMethod === "card" ? "text-neutral-300" : "text-neutral-500"}`}>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className={`text-[10px] ${formData.paymentMethod === "cod" ? "text-neutral-300" : "text-neutral-500"}`}>
              ...
              <div className="pt-6 border-t border-neutral-200 flex items-center justify-between">
                <Link href="/cart" className="text-xs text-neutral-500 hover:text-neutral-900 underline font-semibold">
                  ← Return to Cart
                </Link>
                <button
                  type="submit"
                  className="px-10 py-4 bg-neutral-950 text-white text-xs font-bold uppercase tracking-widest hover:bg-neutral-800 transition-all shadow-md active:scale-95"
                >
          ...
          <div className="lg:col-span-5 bg-neutral-900 text-white p-6 sm:p-8 border border-neutral-800 space-y-6 sticky top-28">
            ...
            <div className="space-y-4 max-h-64 overflow-y-auto pr-2">
              {cartItems.map((item) => (
                <div key={item.id} className="flex justify-between items-center text-xs border-b border-neutral-800/60 pb-3">
                  <div>
                    <p className="font-bold text-neutral-100">{item.title}</p>
                    <p className="text-[10px] text-neutral-400 font-mono mt-0.5">Size: {item.size} | Qty: {item.quantity}</p>
                  </div>
        ...
        <div className="max-w-2xl mx-auto bg-white p-8 sm:p-14 border border-neutral-200 shadow-md text-center space-y-6 my-8 animate-fade-in">
          ...
          <p className="text-sm text-neutral-800 font-medium leading-relaxed bg-neutral-50 p-6 border border-neutral-200 rounded-none">
            Your order has been placed successfully. Expected delivery within 2-3 business days.
          </p>

          <p className="text-xs text-neutral-500 font-light">
            A confirmation receipt and tracking code have been dispatched to <span className="font-semibold text-neutral-900">{formData.email}</span>.
          </p>
